...
NOTES = {
    ...
    ('DoubleGamma', '[0.5, 2]'): _N_ROOT,
    ('FisherZ', '[5, 5]'): _N_ROOT,
    ('FisherZ', '[8, 4]'): _N_ROOT,
    ('GeneralizedGamma', '[0.5, 0.5, 0.5]'): _N_ROOT,
    ('LogGamma', '[0.5, 0.5, 1]'): _N_ROOT,
    ('Muth', '[0.1]'): _N_ROOT,
