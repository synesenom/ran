...
class Distribution {
   ...
   *     distribution.</li>
   *     <li>{pValue}: The p-value of the test. Only present for discrete distributions (the $\chi^2$ branch); the
   *     continuous Anderson-Darling branch does not return this field.</li>
   * </ul>
   * @example
   *
   * let pareto = new ran.dist.Pareto(1, 2)
