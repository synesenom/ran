...
describe('process.BrownianMotion', () => {
  ...
  describe('.lnL()', () => {
    ...
    it('should return a finite number for a path generated by path()', () => {
      const bm = new BrownianMotion(0.1, 1, 1)
      bm.seed(42)
      const path = bm.path(50)
      assert.isTrue(Number.isFinite(bm.lnL(path)))
    })
  })
...
describe('process.GeometricBrownianMotion', () => {
  ...
  describe('.lnL()', () => {
    ...
    it('should return a finite number for a path generated by path()', () => {
      const gbm = new GeometricBrownianMotion(0.05, 0.2, 1)
      gbm.seed(42)
      const path = gbm.path(50)
      assert.isTrue(Number.isFinite(gbm.lnL(path)))
    })
  })
...
describe('process.OrnsteinUhlenbeck', () => {
  ...
  describe('.lnL()', () => {
    ...
    it('should return a finite number for a path generated by path()', () => {
      const ou = new OrnsteinUhlenbeck(0.5, 3, 2, 0.1)
      ou.seed(42)
      const path = ou.path(50)
      assert.isTrue(Number.isFinite(ou.lnL(path)))
    })
  })
