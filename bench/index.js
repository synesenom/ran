...
// fns: { sample, pdf, cdf, quantile }
// null means the operation is unavailable in that library.
var distributions = [
  {
    name: 'Normal',
    ranjs: {
  ...
  {
    name: 'Gamma',
    // jStat Gamma uses (shape, scale); scale = 1/rate. With beta=1, scale=1 — no conversion needed here.
    ranjs: {
...
// Collect results then print table
var rows = []
