...
export default [{
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 1, pmf: 0.41905314307347696, cdf: 0.5587375240979667 },
      { x: 2, pmf: 0.31428985730510756, cdf: 0.8730273814030729 },
      { x: 3, pmf: 0.10476328576836916, cdf: 0.9777906671714417 },
      { x: 4, pmf: 0.019643116081565718, cdf: 0.9974337832530108 },
      { x: 5, pmf: 0.002357173929789828, cdf: 0.9997909571827991 }
    ]
  }, {
    name: 'overdispersion',
    params: () => [1, 0.5],
  ...
  refVals: [
    { x: 0, pmf: 0.011527960359996006, cdf: 0.011527960359996006 },
    { x: 2, pmf: 0.08966191391107915, cdf: 0.14441972562106117 },
    { x: 5, pmf: 0.16273637374860703, cdf: 0.6030404152762369 },
    { x: 8, pmf: 0.07167384049910494, cdf: 0.923734906740178 },
    { x: 12, pmf: 0.0032007456682215953, cdf: 0.998939093503107 },
    { x: 15, pmf: 0.000016707188927530377, cdf: 1 }
  ],
  // scipy.stats.nhypergeom(M=35, n=15, r=7)
  quantileVals: [
    { p: 0.01, x: 0 },
  ...
  cases: [{
    ...
    refVals: [
      { x: 1.0, pmf: 0.7142857142857143, cdf: 0.7142857142857143 },
      { x: 2.0, pmf: 0.15873015873015872, cdf: 0.873015873015873 },
      { x: 3.0, pmf: 0.05772005772005772, cdf: 0.9307359307359307 },
      { x: 5.0, pmf: 0.014208014208014208, cdf: 0.9715839715839716 },
      { x: 8.0, pmf: 0.0035190128069385036, cdf: 0.9887391590177967 },
      { x: 15.0, pmf: 0.0004833206466285862, cdf: 0.9971000761202284 },
      { x: 30.0, pmf: 4.878331537783436e-05, cdf: 0.999414600215466 }
    ]
  }],
  // scipy.stats.yulesimon(alpha=3)
  refVals: [
    { x: 1.0, pmf: 0.75, cdf: 0.75 },
    { x: 2.0, pmf: 0.15, cdf: 0.9 },
    { x: 3.0, pmf: 0.05, cdf: 0.95 },
    { x: 4.0, pmf: 0.02142857142857143, cdf: 0.9714285714285714 },
    { x: 6.0, pmf: 0.005952380952380952, cdf: 0.9880952380952381 },
    { x: 10.0, pmf: 0.001048951048951049, cdf: 0.9965034965034965 },
    { x: 20.0, pmf: 8.46979107848673e-05, cdf: 0.9994353472614342 },
    { x: 50.0, pmf: 2.5612567232988986e-06, cdf: 0.999957312387945 }
  ],
  // scipy.stats.yulesimon(alpha=3)
  quantileVals: [
    { p: 0.01, x: 1 },
