...
export default [{
  ...
  fit: { params: [0, 1, 2], seed: 42, n: 200, tolerances: { mu: 0.5, sigma: 0.4, kappa: 0.6 } },
  ...
  cases: [{
    params: () => [0, 1, 1],
    symmetry: 0,
    // κ=1 reduces to Laplace(0, 1/√2); mpmath: f(x) = (1/√2)·exp(−√2·|x|)  (mu=0,sigma=1,kappa=1)
    refVals: [
      { x: -2, pdf: 0.04179407420105272, cdf: 0.029552873280978113 },
      { x: -1, pdf: 0.17190949153836188, cdf: 0.1215583672171071 },
      { x: 0, pdf: 0.7071067811865476, cdf: 0.5 },
      { x: 1, pdf: 0.17190949153836188, cdf: 0.8784416327828929 },
      { x: 2, pdf: 0.04179407420105272, cdf: 0.9704471267190219 }
    ]
  }, {
    name: 'asymmetric kappa=2',
    params: () => [1, 1, 2],
    // mpmath: C=2√2/5, left rate=2√2, right rate=√2/2  (mu=1,sigma=1,kappa=2)
    refVals: [
      { x: -1, pdf: 0.0019762159660152126, cdf: 0.0006986978553292403 },
      { x: 0, pdf: 0.03343525936084218, cdf: 0.011821149312391248 },
      { x: 1, pdf: 0.565685424949238, cdf: 0.2 },
      { x: 2, pdf: 0.27892177222108094, cdf: 0.6055450468838082 },
      { x: 3, pdf: 0.13752759323068953, cdf: 0.8055066124526287 },
      { x: 5, pdf: 0.03343525936084218, cdf: 0.952715402750435 }
    ],
  ...
  quantileVals: [
    { p: 0.01, x: -2.76621799529602 },
    { p: 0.05, x: -1.6281735335151466 },
    { p: 0.25, x: -0.49012907173427356 },
    { p: 0.5, x: 0 },
    { p: 0.75, x: 0.49012907173427356 },
    { p: 0.95, x: 1.6281735335151462 },
    { p: 0.99, x: 2.766217995296019 }
  ]
}, {
  name: 'BaldingNichols',
  ...
  refVals: [
    { x: 1e-6, pdf: 3.999999999988e-6, cdf: 1.999999999997e-12 },
    { x: 1e-4, pdf: 3.9999998800000023e-4, cdf: 1.9999999700000005e-8 },
    { x: 0.1, pdf: 0.3882360591710578, cdf: 0.01970395059307911 },
    { x: 0.25, pdf: 0.833706492977814, cdf: 0.11418685121107267 },
    { x: 0.5, pdf: 1.024, cdf: 0.36 },
    { x: 1, pdf: 0.5, cdf: 0.75 },
    { x: 2, pdf: 0.064, cdf: 0.96 },
    { x: 3, pdf: 0.012, cdf: 0.99 },
    { x: 5, pdf: 0.001137915339098771, cdf: 0.9985207100591716 },
    { x: 8, pdf: 0.00011652253072371416, cdf: 0.9997633136094675 },
    { x: 10, pdf: 3.882360591710578e-05, cdf: 0.9999019703950593 }
  ],
  ...
  // gen-dist-refs.py dps=50: Champernowne(alpha=2, lambda=0.5, x0=1)
  refVals: [
    { x: -3, pdf: 0.0005546645886305676, cdf: 0.00027737882722761226 },
    { x: -1, pdf: 0.029739154875803118, cdf: 0.015008221681761169 },
    { x: 0, pdf: 0.1940298857846274, cdf: 0.10440985661657781 },
    { x: 1, pdf: 0.5513288954217921, cdf: 0.5 },
    { x: 2, pdf: 0.1940298857846274, cdf: 0.8955901433834222 },
    { x: 3, pdf: 0.029739154875803118, cdf: 0.9849917783182388 },
    { x: 5, pdf: 0.0005546645886305676, cdf: 0.9997226211727724 }
  ],
  ...
  // Regression #1075 is inherited from DoublyNoncentralBeta (see its own cases block for the
  // Beta-function-underflow root cause and why no large-lambda case is added here — MAX_ITER=100
  // truncation noise fails cdf2pdf/quantile checks at this scale, a pre-existing limitation
  // orthogonal to this fix); DoublyNoncentralF delegates _pdf/_cdf via super._pdf/super._cdf, so
  // it is fixed automatically. Coverage lives in test/dist-base-special-cases.js as direct
  // finite-value checks for lambda1 = lambda2 up to 50000.
  ...
  cases: [{
    ...
    name: 'mu=0',
    params: () => [5, 0, 2],
    // gen-dist-refs.py dps=50: DoublyNoncentralT(nu=5, mu=0, theta=2) — mu=0 is a Poisson mixture of central Student-t
    refVals: [
      { x: -3, pdf: 0.009725740177368164, cdf: 0.007564145101591659 },
      { x: -2, pdf: 0.04619847898398459, cdf: 0.030678973517988446 },
      { x: -1, pdf: 0.2152586095336008, cdf: 0.14328554525034287 },
      { x: 0, pdf: 0.45064585299485316, cdf: 0.5 },
      { x: 1, pdf: 0.2152586095336008, cdf: 0.8567144547496571 },
      { x: 2, pdf: 0.04619847898398459, cdf: 0.9693210264820116 },
      { x: 3, pdf: 0.009725740177368164, cdf: 0.9924358548984084 },
      { x: 5, pdf: 0.0007889413111928885, cdf: 0.9991279930394737 }
    ]
  }],
  ...
  // gen-dist-refs.py dps=50: FisherZ(d1=5, d2=5)
  refVals: [
    { x: -3, pdf: 8.206835480762965e-06, cdf: 1.6471841028035408e-06 },
    { x: -1, pdf: 0.09702323575946462, cdf: 0.023327569577639522 },
    { x: -0.5, pdf: 0.46557914854105104, cdf: 0.14824838873385382 },
    { x: 0, pdf: 0.8488263631567752, cdf: 0.5 },
    { x: 0.5, pdf: 0.46557914854105104, cdf: 0.8517516112661462 },
    { x: 1, pdf: 0.09702323575946462, cdf: 0.9766724304223605 },
    { x: 3, pdf: 8.206835480762965e-06, cdf: 0.9999983528158972 }
  ],
  ...
  // gen-dist-refs.py dps=50: HyperbolicSecant()
  refVals: [
    { x: -5.0, pdf: 0.0003882031454238816, cdf: 0.0002471378229015252 },
    { x: -2.0, pdf: 0.04313336916702721, cdf: 0.027493729001074486 },
    ...
    { x: 4.0, pdf: 0.0018674362193185636, cdf: 0.9988111504152044 }
  ],
  ...
  cases: [{
    ...
    refVals: [
      { x: 0.01, pdf: 2.6352313834736494, cdf: 0.0513167019494862 },
      { x: 0.1, pdf: 0.9560580838703866, cdf: 0.17309478536947048 },
      ...
      { x: 0.9, pdf: 1.1632937248661048, cdf: 0.773468099488204 },
      { x: 0.99, pdf: 3.54888963740793, cdf: 0.9292005445403706 }
    ]
  }],
  refVals: [
  ...
  refVals: [
    { x: 0.5, pdf: 2.2145328719723184e-1, cdf: 5.8823529411764705e-2 },
    { x: 1, pdf: 3.2e-1, cdf: 2e-1 },
    { x: 1.5, pdf: 3.072e-1, cdf: 3.6e-1 },
    { x: 2, pdf: 2.5e-1, cdf: 5e-1 },
    { x: 3, pdf: 1.4201183431952663e-1, cdf: 6.923076923076923e-1 },
  ...
  refVals: [
    ...
    { x: 1e-4, pdf: 3.9988001199946672, cdf: 3.999400039998667e-4 },
    { x: 0.1, pdf: 2.915039271083056, cdf: 0.3438742118296962 },
    { x: 0.25, pdf: 1.6795113601255536, cdf: 0.6829580789220578 },
    { x: 0.5, pdf: 0.49072422915865943, cdf: 0.9340119641546875 },
    { x: 0.75, pdf: 0.0752357613050058, cdf: 0.9931375384174822 },
    { x: 1, pdf: 0.0038143656446380262, cdf: 0.9997726582347491 },
    { x: 1.25, pdf: 3.0115907246639975e-5, cdf: 0.9999988577310432 },
    { x: 1.5, pdf: 1.0799107003953017e-8, cdf: 0.9999999997439215 },
    { x: 2, pdf: 1.0753048622834176e-23, cdf: 1 }
  ],
  ...
  cases: [{
    ...
    refVals: [
      { x: 0.05, pdf: 0.015878101899080472, cdf: 0.0002651650586556098 },
      { x: 0.1, pdf: 0.06256683103607294, cdf: 0.002102341288023695 },
      { x: 0.3, pdf: 0.47984342816419145, cdf: 0.05162424102969328 },
      { x: 0.5, pdf: 0.9678828980765734, cdf: 0.1987480430987992 },
      { x: 0.8, pdf: 1.1358293471176248, cdf: 0.5354547456266262 },
      { x: 1.2, pdf: 0.5159699779931803, cdf: 0.8761111827355619 },
      { x: 2.0, pdf: 0.008565134448952662, cdf: 0.9988660157102147 }
    ]
  }],
  refVals: [
    { x: 0, pdf: 0, cdf: 0 },
    { x: 0.2, pdf: 0.003969525474770118, cdf: 0.0002651650586556098 },
    { x: 0.5, pdf: 0.024166757300178074, cdf: 0.004078592964422845 },
    { x: 1, pdf: 0.08801633169107487, cdf: 0.03085959578372673 },
    { x: 2, pdf: 0.24197072451914334, cdf: 0.1987480430987992 },
    { x: 3, pdf: 0.2914145902482564, cdf: 0.4778328104646087 },
    { x: 4, pdf: 0.2159638660527522, cdf: 0.7385358700508894 },
    { x: 5, pdf: 0.10955187808480336, cdf: 0.899939166880605 },
    { x: 6, pdf: 0.03988663570744207, cdf: 0.9707091134651118 },
    { x: 8, pdf: 0.0021412836122381654, cdf: 0.9988660157102147 }
  ],
  ...
  cases: [{
    ...
    refVals: [
      { x: 0.1, pdf: 1.5809609708633867, cdf: 0.3162238133920946 },
  ...
  refVals: [
    { x: 0.1, pdf: 0.19605920988138417, cdf: 0.009900990099009901 },
    { x: 0.3, pdf: 0.5050079959599361, cdf: 0.08256880733944955 },
    { x: 0.5, pdf: 0.64, cdf: 0.2 },
    { x: 0.8, pdf: 0.594883997620464, cdf: 0.3902439024390244 },
  ...
  refVals: [
    ...
    { x: 14, pdf: 4.567360204182297e-12, cdf: 0.9999999999987201 }
  ],
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 0.1, pdf: 1.5811388300841898, cdf: 0.31622776601683794 },
      ...
      { x: 0.95, pdf: 0.5129891760425771, cdf: 0.9746794344808964 }
    ]
  }],
  ...
  cases: [{
    ...
    refVals: [
      { x: -0.9, pdf: 0.6626170144884796, cdf: 0.25700495182569666 },
      ...
      { x: 0.9, pdf: 0.6626170144884796, cdf: 0.7429950481743034 }
    ]
  }],
  ...
  // gen-dist-refs.py dps=50: ShiftedLogLogistic(mu=0, sigma=2, xi=2); x=-2 is below support (mu-sigma/xi=-1) so pdf=cdf=0
  refVals: [
    { x: -2, pdf: 0, cdf: 0 },
    { x: -0.9, pdf: 0.912657670484702, cdf: 0.24025307335204216 },
    { x: 0, pdf: 0.125, cdf: 0.5 },
    { x: 0.5, pdf: 0.08248290463863016, cdf: 0.5505102572168219 },
    { x: 1, pdf: 0.06066017177982129, cdf: 0.585786437626905 },
    { x: 2, pdf: 0.03867513459481288, cdf: 0.6339745962155614 },
    { x: 4, pdf: 0.021352549156242115, cdf: 0.6909830056250525 },
    { x: 6, pdf: 0.014218274778803025, cdf: 0.7257081148225683 },
    { x: 8, pdf: 0.010416666666666666, cdf: 0.75 }
  ],
  ...
  refVals: [
    ...
    { x: -2, pdf: 0.06804138174397717, cdf: 0.09175170953613698 },
    { x: -1, pdf: 0.19245008972987526, cdf: 0.2113248654051871 },
    { x: 0, pdf: 0.3535533905932738, cdf: 0.5 },
    { x: 1, pdf: 0.19245008972987526, cdf: 0.7886751345948129 },
    { x: 2, pdf: 0.06804138174397717, cdf: 0.908248290463863 },
    { x: 4, pdf: 0.013094570021973102, cdf: 0.9714045207910317 },
    { x: 6, pdf: 0.004268984766599014, cdf: 0.9866642633922876 }
  ],
  // scipy.stats.t(df=2)
  quantileVals: [
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 0.2, pdf: 1.7777777777777777, cdf: 0.28888888888888886 },
      { x: 0.4, pdf: 1.3333333333333333, cdf: 0.6 },
      { x: 0.6, pdf: 0.8888888888888888, cdf: 0.8222222222222222 },
      { x: 0.8, pdf: 0.4444444444444444, cdf: 0.9555555555555556 },
      { x: 0.95, pdf: 0.1111111111111111, cdf: 0.9972222222222222 }
    ]
  }],
  refVals: [
    { x: 4, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 0.9, pdf: 1.92, cdf: 0.756 },
      { x: 0.98, pdf: 2.7648, cdf: 0.942368 }
    ]
  }],
  refVals: [
  ...
  // gen-dist-refs.py dps=50: UniformRatio() — f=1/2 for x<=1, 1/(2x^2) for x>1
  refVals: [
    ...
    { x: 1.0, pdf: 0.5, cdf: 0.5 },
    { x: 1.5, pdf: 0.2222222222222222, cdf: 0.6666666666666666 },
