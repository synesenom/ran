export default [{
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.01, pdf: 0.868123445394585, cdf: 0.00910535957630703 },
      { x: 0.1, pdf: 0.639407319161897, cdf: 0.0746410346467217 },
      { x: 0.3, pdf: 0.460889634482101, cdf: 0.182106789760138 },
      { x: 0.5, pdf: 0.367879441171442, cdf: 0.264241117657115 },
      { x: 1.0, pdf: 0.243116734434214, cdf: 0.413064282489062 },
      { x: 2.0, pdf: 0.135335283236613, cdf: 0.593994150290162 },
      { x: 5.0, pdf: 0.042329219623205, cdf: 0.823814034789973 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [0.5],
    refVals: [
      { x: 0.05, pdf: 1.58781018990805, cdf: 0.079655674554058 },
      { x: 0.1, pdf: 1.56417077590182, cdf: 0.158519418878206 },
      { x: 0.3, pdf: 1.3328984115672, cdf: 0.451493764499853 },
      { x: 0.5, pdf: 0.967882898076573, cdf: 0.682689492137086 },
      { x: 1.0, pdf: 0.215963866052752, cdf: 0.954499736103642 },
      { x: 1.5, pdf: 0.017727393647752, cdf: 0.99730020393674 },
      { x: 2.5, pdf: 5.94687805893719e-06, cdf: 0.999999426696856 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    refVals: [
      { x: 0.01, pdf: 3.00674487735605, cdf: 0.030654800837587 },
      { x: 0.05, pdf: 2.57810599823749, cdf: 0.14212445718443 },
      { x: 0.1, pdf: 2.12986381616951, cdf: 0.259452609348092 },
      { x: 0.3, pdf: 1.01117113278974, cdf: 0.558927346959584 },
      { x: 0.5, pdf: 0.503355947593764, cdf: 0.703798341804689 },
      { x: 1.0, pdf: 0.130763249130282, cdf: 0.834630605905291 },
      { x: 2.0, pdf: 0.0469913180301378, cdf: 0.907778542736213 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [2],
    refVals: [
      { x: 0.1, pdf: 0.336897349954273, cdf: 0.00673794699908547 },
      { x: 0.3, pdf: 1.04930890465312, cdf: 0.188875602837562 },
      { x: 0.5, pdf: 0.735758882342885, cdf: 0.367879441171442 },
      { x: 1.0, pdf: 0.303265329856317, cdf: 0.606530659712633 },
      { x: 2.0, pdf: 0.0973500978839256, cdf: 0.778800783071405 },
      { x: 5.0, pdf: 0.0180967483607192, cdf: 0.90483741803596 },
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.05, pdf: 0.00161998219121782, cdf: 7.74421643104409e-06 },
      { x: 0.1, pdf: 0.0850036660252034, cdf: 0.00156540225800255 },
      { x: 0.3, pdf: 0.458568318794024, cdf: 0.0678891548618289 },
      { x: 0.5, pdf: 0.415107497420595, cdf: 0.157299207050281 },
      { x: 1.0, pdf: 0.241970724519143, cdf: 0.317310507862911 },
      { x: 3.0, pdf: 0.0649898852409137, cdf: 0.563702861650773 },
  ...
  cases: [{
    ...
    params: () => [1, 0.5],
    refVals: [
      { x: 0.2, pdf: 1.41714565306224, cdf: 0.18148218448675 },
      { x: 0.5, pdf: 0.704130653528599, cdf: 0.49013833994533 },
      { x: 1.0, pdf: 0.282094791773878, cdf: 0.713791788077904 },
      { x: 2.0, pdf: 0.0880163316910749, cdf: 0.873063262493356 },
      { x: 4.0, pdf: 0.0200915959123502, cdf: 0.960367406995254 },
      { x: 8.0, pdf: 0.00269616621332849, cdf: 0.993170405016885 },
      { x: 15.0, pdf: 0.000185166693654353, cdf: 0.999445762349999 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 2.0, pdf: 0.0871630538190878, cdf: 0.49306869139524 },
      { x: 5.0, pdf: 0.0285951646191381, cdf: 0.639407319161897 },
      { x: 15.0, pdf: 0.00664811866432609, cdf: 0.772441586116369 }
    ]
  }],
  refVals: [
    { x: 0, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 1.0, pdf: 0.5, cdf: 0.166666666666667 },
      { x: 1.5, pdf: 0.75, cdf: 0.5 },
      { x: 2.0, pdf: 0.5, cdf: 0.833333333333333 },
      { x: 2.5, pdf: 0.125, cdf: 0.979166666666667 },
      { x: 2.9, pdf: 0.00500000000000001, cdf: 0.999833333333333 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [1, 0.5, 0.5, 1],
    refVals: [
      { x: -1.0, pdf: 0.0966492809043423, cdf: 0.481114639240948 },
      { x: 0, pdf: 0.171641003046005, cdf: 0.609563774882999 },
      { x: 0.5, pdf: 0.241248500346702, cdf: 0.712026008086888 },
      { x: 1.0, pdf: 0.241970724519143, cdf: 0.841344746068543 },
      { x: 1.5, pdf: 0.0999284007457743, cdf: 0.925163406218179 },
      { x: 2.0, pdf: 0.0405189444451057, cdf: 0.957448729801813 },
      { x: 3.0, pdf: 0.0118980701912261, cdf: 0.97968844181964 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [1, 0.5, 0.5, 1],
    refVals: [
      { x: 1.05, pdf: 4.41119171763404, cdf: 0.460723056317701 },
      { x: 1.1, pdf: 2.37872256012632, cdf: 0.620522298879915 },
      { x: 1.2, pdf: 1.20968516586556, cdf: 0.787352138712046 },
      { x: 1.3, pdf: 0.806456777243705, cdf: 0.885460083986399 },
      { x: 1.4, pdf: 0.59468064003158, cdf: 0.954786272209776 },
      { x: 1.45, pdf: 0.490132413070449, cdf: 0.982074453899657 },
      { x: 1.49, pdf: 0.265562217838547, cdf: 0.998389970385148 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.01, pdf: 2.63523138347365, cdf: 0.0513167019494862 },
      { x: 0.1, pdf: 0.956058083870386, cdf: 0.173094785369471 },
      { x: 0.25, pdf: 0.707106781186548, cdf: 0.292893218813452 },
      { x: 0.5, pdf: 0.653281482438188, cdf: 0.458803899853803 },
      { x: 0.75, pdf: 0.788675134594813, cdf: 0.633974596215561 },
      { x: 0.9, pdf: 1.1632937248661, cdf: 0.773468099488204 },
      { x: 0.99, pdf: 3.54888963740793, cdf: 0.929200544540371 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 2.5, pdf: 0.367879441171442, cdf: 0.183939720585721 },
      { x: 3.0, pdf: 1.0, cdf: 0.5 },
      { x: 3.5, pdf: 0.367879441171442, cdf: 0.816060279414279 },
      { x: 4.0, pdf: 0.135335283236613, cdf: 0.932332358381694 },
      { x: 5.0, pdf: 0.0183156388887342, cdf: 0.990842180555633 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [1, 0.5],
    refVals: [
      { x: 1.05, pdf: 0.170007332050407, cdf: 0.00156540225800256 },
      { x: 1.1, pdf: 0.732249128096325, cdf: 0.0253473186774683 },
      { x: 1.3, pdf: 0.746107005296797, cdf: 0.196705602458947 },
      { x: 1.5, pdf: 0.483941449038287, cdf: 0.317310507862914 },
      { x: 2.0, pdf: 0.219695644733861, cdf: 0.479500122186953 },
      { x: 4.0, pdf: 0.0499484457833488, cdf: 0.683091398309609 },
      { x: 8.0, pdf: 0.0146972976889228, cdf: 0.789268026134281 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5],
    refVals: [
      { x: 0.1, pdf: 0.174392061158464, cdf: 0.0170629280159288 },
      { x: 0.5, pdf: 0.194700195767851, cdf: 0.0913990864166943 },
      { x: 1.0, pdf: 0.202176886570878, cdf: 0.191292453716489 },
      { x: 2.0, pdf: 0.183939720585721, cdf: 0.386867598047596 },
      { x: 4.0, pdf: 0.112779402697177, cdf: 0.684217672447904 },
      { x: 7.0, pdf: 0.0402631778964247, cdf: 0.899342055258938 },
      { x: 12.0, pdf: 0.00537062971611044, cdf: 0.987606239116668 }
    ]
  }],
  refVals: [
    { x: -0.5, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    params: () => [1, 0.5],
    refVals: [
      { x: 0.5, pdf: 0.102128869581514, cdf: 0.0914016391820454 },
      { x: 1.0, pdf: 0.127323954473516, cdf: 0.147583617650433 },
      { x: 2.0, pdf: 0.23122321899773, cdf: 0.3247906930983 },
      { x: 5.0, pdf: 0.0512234347254905, cdf: 0.781297684824775 },
      { x: 10.0, pdf: 0.00817551035713249, cdf: 0.88333664946324 },
      { x: 20.0, pdf: 0.00187995422010327, cdf: 0.92186072925253 },
      { x: 50.0, pdf: 0.000364621231547542, cdf: 0.945873368997158 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5, 1],
    refVals: [
      { x: 1.1, pdf: 1.12008606358955, cdf: 0.242468109726797 },
      { x: 1.3, pdf: 0.525463672375968, cdf: 0.391499493583331 },
      { x: 1.0, pdf: Infinity, cdf: 0 },
      { x: 2.0, pdf: 0.169415187900776, cdf: 0.594904033566975 },
      { x: 5.0, pdf: 0.0281266458932936, cdf: 0.795429167714896 },
      { x: 10.0, pdf: 0.00831385070544547, cdf: 0.870841121301594 },
  ...
  cases: [{
    ...
    params: () => [1, 0.5],
    refVals: [
      { x: 0.3, pdf: 0.0406005849709838, cdf: 0.00609008774564757 },
      { x: 0.7, pdf: 0.0947346982656289, cdf: 0.0331571443929701 },
      { x: 1.5, pdf: 0.203002924854919, cdf: 0.152252193641189 },
      { x: 2.7, pdf: 0.365405264738854, cdf: 0.493297107397453 },
      { x: 5.0, pdf: 0.0591124487914452, cdf: 0.852218878021387 },
      { x: 10.0, pdf: 0.00738905609893065, cdf: 0.963054719505347 },
      { x: 20.0, pdf: 0.000923632012366331, cdf: 0.990763679876337 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.01, pdf: 5.42741479394292, cdf: 0.123899343099295 },
      { x: 0.1, pdf: 1.06762745781211, cdf: 0.309016994374947 },
      { x: 0.5, pdf: 0.25, cdf: 0.5 },
      { x: 1.0, pdf: 0.121320343559643, cdf: 0.585786437626905 },
      { x: 5.0, pdf: 0.018253153409694, cdf: 0.759746926647958 },
      { x: 20.0, pdf: 0.00294718553803102, cdf: 0.863472940504186 },
      { x: 100.0, pdf: 0.000308397421828984, cdf: 0.933959117468689 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [1, 0.5],
    refVals: [
      { x: 0.5, pdf: 0.00516350884349194, cdf: 0.000354216744666189 },
      { x: 1.0, pdf: 0.107981933026376, cdf: 0.0227501319481792 },
      { x: 2.0, pdf: 0.330464565983484, cdf: 0.26970493073491 },
      { x: 4.0, pdf: 0.148001572447282, cdf: 0.780117089512224 },
      { x: 7.0, pdf: 0.0190403756200115, cdf: 0.970742536062737 },
      { x: 12.0, pdf: 0.000808286874626035, cdf: 0.998510096060727 },
      { x: 20.0, pdf: 1.38473283672621e-05, cdf: 0.999967166746856 }
    ]
  }],
  refVals: [
    { x: -0.1, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    params: () => [2, 10],
    refVals: [
      { x: 2.1, pdf: 0.05439600187776, cdf: 0.00526219913746127 },
      { x: 3.0, pdf: 0.0805460414438611, cdf: 0.0666841697012067 },
      { x: 4.0, pdf: 0.101637788158663, cdf: 0.158281031532563 },
      { x: 5.5, pdf: 0.124985594922888, cdf: 0.329176401266225 },
      { x: 7.0, pdf: 0.142666672427136, cdf: 0.530448086472721 },
      { x: 9.0, pdf: 0.161092082887722, cdf: 0.834977792528844 },
      { x: 9.9, pdf: 0.168079859896705, cdf: 0.983155109692181 }
    ]
  }],
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 2.0, pdf: 0.209987170807013, cdf: 0.119202922022118 },
      { x: 3.0, pdf: 0.5, cdf: 0.5 },
      { x: 4.0, pdf: 0.209987170807013, cdf: 0.880797077977882 },
      { x: 5.0, pdf: 0.0353254124265822, cdf: 0.982013790037908 },
      { x: 7.0, pdf: 0.000670475341512948, cdf: 0.999664649869534 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.1, pdf: 0.771670747596172, cdf: 0.184626104163516 },
      { x: 0.5, pdf: 0.25632119231863, cdf: 0.347658896197838 },
      { x: 1.0, pdf: 0.156998585865445, cdf: 0.44611605086952 },
      { x: 2.0, pdf: 0.0970846032619513, cdf: 0.567255522670084 },
      { x: 4.0, pdf: 0.0587269731777749, cdf: 0.716525826365985 },
      { x: 8.0, pdf: 0.0269267591549914, cdf: 0.879823230685725 },
      { x: 15.0, pdf: 0.00561694056108503, cdf: 0.97701641934402 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [1, 0.5],
    refVals: [
      { x: 0.2, pdf: 5.64581193722846e-05, cdf: 9.09364730874625e-07 },
      { x: 0.4, pdf: 0.063970109919523, cdf: 0.00246992493195685 },
      { x: 0.6, pdf: 1.63948394992965, cdf: 0.117206103768475 },
      { x: 0.7, pdf: 3.62632779217133, cdf: 0.380029131516444 },
      { x: 0.8, pdf: 3.70003931118205, cdf: 0.780117089512224 },
      { x: 0.9, pdf: 0.504322607645773, cdf: 0.991677324435874 },
      { x: 0.98, pdf: 2.21819908775979e-06, cdf: 0.999999996344948 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.01, pdf: 0.970732885271249, cdf: 0.00985245702332569 },
      { x: 0.1, pdf: 0.760725774312731, cdf: 0.0871290708247231 },
      { x: 0.5, pdf: 0.353553390593274, cdf: 0.292893218813452 },
      { x: 1.0, pdf: 0.192450089729875, cdf: 0.422649730810374 },
      { x: 5.0, pdf: 0.0274101222343421, cdf: 0.698488655422236 },
      { x: 20.0, pdf: 0.00380911614362454, cdf: 0.843826238111394 },
      { x: 100.0, pdf: 0.000350918216845074, cdf: 0.92946543841414 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5, 0.5],
    refVals: [
      { x: 0.1, pdf: 0.926854550737487, cdf: 0.0963119868700351 },
      { x: 0.5, pdf: 0.669493932002242, cdf: 0.413759648110105 },
      { x: 1.0, pdf: 0.419877840031388, cdf: 0.682958078922058 },
      { x: 2.0, pdf: 0.122681057289665, cdf: 0.934011964154687 },
      { x: 4.0, pdf: 0.000953591411159506, cdf: 0.999772658234749 },
      { x: 7.0, pdf: 5.81201701885707e-15, cdf: 1 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5],
    refVals: [
      { x: 0.05, pdf: 0.0158781018990805, cdf: 0.00026516505865561 },
      { x: 0.1, pdf: 0.062566831036073, cdf: 0.0021023412880237 },
      { x: 0.3, pdf: 0.479843428164191, cdf: 0.0516242410296933 },
      { x: 0.5, pdf: 0.967882898076573, cdf: 0.198748043098799 },
      { x: 0.8, pdf: 1.13582934711762, cdf: 0.535454745626626 },
      { x: 1.2, pdf: 0.51596997799318, cdf: 0.876111182735562 },
      { x: 2.0, pdf: 0.00856513444895266, cdf: 0.998866015710215 }
    ]
  }],
  refVals: [
    { x: 0, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    params: () => [0.5, 4],
    refVals: [
      { x: 0.1, pdf: 1.58096097086339, cdf: 0.316223813392095 },
      { x: 0.3, pdf: 0.904623385188273, cdf: 0.547170500764978 },
      { x: 0.5, pdf: 0.660488022070762, cdf: 0.701768523450185 },
      { x: 1.0, pdf: 0.229251010801168, cdf: 0.917004043204671 },
      { x: 2.0, pdf: 0.0145948612280852, cdf: 0.992450563509793 },
      { x: 5.0, pdf: 0.000159712488785344, cdf: 0.999800179796255 },
      { x: 10.0, pdf: 4.9994375597594e-06, cdf: 0.999987500703075 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [3, 0.5],
    refVals: [
      { x: 3.0, pdf: 0.483941449038287, cdf: 0.317310507862914 },
      { x: 3.2, pdf: 0.467221712132061, cdf: 0.412940046685082 },
      { x: 3.5, pdf: 0.402632488129776, cdf: 0.544162429362303 },
      { x: 4.0, pdf: 0.274320267891288, cdf: 0.712963130479188 },
      { x: 5.0, pdf: 0.106997568177766, cdf: 0.892346789695769 },
      { x: 7.0, pdf: 0.0146113145100329, cdf: 0.985387051530355 },
      { x: 10.0, pdf: 0.000727576239090187, cdf: 0.999272423559243 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.1],
    refVals: [
      { x: 0.1, pdf: 0.831306081211651, cdf: 0.0865271923687633 },
      { x: 1.0, pdf: 0.388076968748772, cdf: 0.613919422289169 },
      { x: 3.0, pdf: 0.0510189837684384, cdf: 0.959180202228294 },
      { x: 6.0, pdf: 0.000843768314022099, cdf: 0.999510040588471 },
      { x: 10.0, pdf: 2.45418732603179e-07, cdf: 0.999999906267259 },
      { x: 15.0, pdf: 1.48696165612724e-14, cdf: 0.999999999999997 },
      { x: 22.0, pdf: 1.13205086743551e-33, cdf: 1.0 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.05, pdf: 1.12556174242602, cdf: 0.0563719777970166 },
      { x: 0.1, pdf: 1.11715160678894, cdf: 0.112462916018285 },
      { x: 0.3, pdf: 1.03126090961896, cdf: 0.328626759459127 },
      { x: 0.5, pdf: 0.878782578935445, cdf: 0.520499877813047 },
      { x: 0.8, pdf: 0.594985786257469, cdf: 0.742100964707661 },
      { x: 1.2, pdf: 0.267344347003539, cdf: 0.910313978229635 },
  ...
  cases: [{
    ...
    params: () => [2, 0.5],
    refVals: [
      { x: 0.1, pdf: 0.0878644326322349, cdf: 0.00440284612081845 },
      { x: 0.5, pdf: 0.39550858106986, cdf: 0.10449141893014 },
      { x: 1.0, pdf: 0.569241628229192, cdf: 0.357285769727456 },
      { x: 1.5, pdf: 0.492349946125542, cdf: 0.63093101599379 },
      { x: 2.0, pdf: 0.302420011602264, cdf: 0.830859361490533 },
      { x: 3.0, pdf: 0.0484317182760648, cdf: 0.982156326613518 },
      { x: 4.0, pdf: 0.00269943686188662, cdf: 0.999262964693195 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [2, 10, 0.5],
    refVals: [
      { x: 0.05, pdf: 0.744608892287108, cdf: 0.0380781848534264 },
      { x: 0.1, pdf: 0.712067842112604, cdf: 0.0744884009743204 },
      { x: 0.5, pdf: 0.501992982043995, cdf: 0.314572661553609 },
      { x: 1.0, pdf: 0.330958307396551, cdf: 0.519462330369143 },
      { x: 2.0, pdf: 0.153668505046733, cdf: 0.748937388324606 },
      { x: 5.0, pdf: 0.0235300056098439, cdf: 0.948048863447845 },
      { x: 10.0, pdf: 0.00249901238981399, cdf: 0.992023187421851 }
    ]
  }],
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 2.5, pdf: 0.483941449038287, cdf: 0.158655253931457 },
      { x: 3.0, pdf: 0.797884560802865, cdf: 0.5 },
      { x: 3.5, pdf: 0.483941449038287, cdf: 0.841344746068543 },
      { x: 4.0, pdf: 0.107981933026376, cdf: 0.977249868051821 },
  ...
  cases: [{
    ...
    params: () => [1, 0.5],
    refVals: [
      { x: 1.01, pdf: 0.492592668420787, cdf: 0.00496280979001085 },
      { x: 1.1, pdf: 0.433392086020724, cdf: 0.0465374107544078 },
      { x: 1.5, pdf: 0.272165526975909, cdf: 0.183503419072274 },
      { x: 2.0, pdf: 0.176776695296637, cdf: 0.292893218813452 },
      { x: 5.0, pdf: 0.0447213595499958, cdf: 0.552786404500042 },
      { x: 15.0, pdf: 0.0086066296582387, cdf: 0.741801110252839 },
      { x: 50.0, pdf: 0.0014142135623731, cdf: 0.858578643762691 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0, 0.5, 1],
    refVals: [
      { x: 0.05, pdf: 0.0676875, cdf: 0.001158125 },
      { x: 0.2, pdf: 0.767999999999999, cdf: 0.05792 },
      { x: 0.4, pdf: 1.728, cdf: 0.31744 },
      { x: 0.5, pdf: 1.875, cdf: 0.5 },
      { x: 0.6, pdf: 1.728, cdf: 0.68256 },
      { x: 0.8, pdf: 0.768, cdf: 0.94208 },
      { x: 0.95, pdf: 0.0676875000000002, cdf: 0.998841875 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 0.05, pdf: 2.23606797749979, cdf: 0.223606797749979 },
      { x: 0.1, pdf: 1.58113883008419, cdf: 0.316227766016838 },
      { x: 0.25, pdf: 1.0, cdf: 0.5 },
      { x: 0.5, pdf: 0.707106781186548, cdf: 0.707106781186548 },
      { x: 0.75, pdf: 0.577350269189626, cdf: 0.866025403784439 },
      { x: 0.95, pdf: 0.512989176042577, cdf: 0.974679434480896 }
    ]
  }],
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: -0.2, pdf: 0.196618491289814, cdf: 0.461472406892141 },
      { x: 0, pdf: 0.190689940875453, cdf: 0.5 },
      { x: 0.2, pdf: 0.196618491289814, cdf: 0.538527593107859 },
      { x: 0.5, pdf: 0.236609314080785, cdf: 0.602243221682644 },
      { x: 0.9, pdf: 0.662617014488479, cdf: 0.742995048174303 }
    ]
  }],
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 2.8, pdf: 1.30901699437495, cdf: 0.148634654271868 },
      { x: 3.0, pdf: 2.0, cdf: 0.5 },
      { x: 3.2, pdf: 1.30901699437495, cdf: 0.851365345728132 },
      { x: 3.35, pdf: 0.412214747707527, cdf: 0.978759053700121 },
      { x: 3.45, pdf: 0.048943483704846, cdf: 0.999181582154173 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0.5],
    refVals: [
      { x: 0.05, pdf: 0.199002495838537, cdf: 0.00498752080731769 },
      { x: 0.1, pdf: 0.392079469322702, cdf: 0.0198013266932447 },
      { x: 0.3, pdf: 1.00232425369353, cdf: 0.164729788588728 },
      { x: 0.5, pdf: 1.21306131942527, cdf: 0.393469340287367 },
      { x: 0.8, pdf: 0.889719361450221, cdf: 0.721962699546806 },
      { x: 1.2, pdf: 0.269446861603842, cdf: 0.943865237165866 },
      { x: 2.0, pdf: 0.0026837010232201, cdf: 0.999664537372097 }
    ]
  }],
  refVals: [
    { x: 0, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    params: () => [1, 10],
    refVals: [
      { x: 1.05, pdf: 0.413613792288811, cdf: 0.0211892990699381 },
      { x: 1.5, pdf: 0.289529654602168, cdf: 0.176091259055681 },
      { x: 2.0, pdf: 0.217147240951626, cdf: 0.301029995663981 },
      { x: 3.0, pdf: 0.144764827301084, cdf: 0.477121254719662 },
      { x: 5.0, pdf: 0.0868588963806504, cdf: 0.698970004336019 },
      { x: 7.0, pdf: 0.0620420688433217, cdf: 0.845098040014257 },
      { x: 9.5, pdf: 0.0457152086213949, cdf: 0.977723605288848 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [0.5, 4],
    refVals: [
      { x: 0.2, pdf: 1.51455081839134e-14, cdf: 1.11022302462516e-16 },
      { x: 0.5, pdf: 0.000139253051946748, cdf: 4.21422967222806e-06 },
      { x: 1.0, pdf: 0.107981933026376, cdf: 0.0139832050962067 },
      { x: 2.0, pdf: 0.564189583547756, cdf: 0.431500271187469 },
      { x: 5.0, pdf: 0.0097497824322559, cdf: 0.994655173561547 },
      { x: 10.0, pdf: 6.96579506240829e-07, cdf: 0.999999647257995 },
      { x: 20.0, pdf: 1.51455081839133e-15, cdf: 0.999999999999999 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [0.5, 2],
    refVals: [
      { x: 0.5, pdf: 0.117541335297558, cdf: 0.0298346588097693 },
      { x: 1.0, pdf: 0.214672446073057, cdf: 0.114105851939041 },
      { x: 2.0, pdf: 0.29854553991801, cdf: 0.384102526735185 },
      { x: 3.0, pdf: 0.244367981024342, cdf: 0.66401183046153 },
      { x: 4.0, pdf: 0.139498660374847, cdf: 0.856206716889932 },
      { x: 6.0, pdf: 0.0185031268416663, cdf: 0.987298321978845 },
      { x: 10.0, pdf: 1.29171186016568e-05, cdf: 0.999994694723664 }
    ]
  }],
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: -1.0, pdf: 0.118304657040393, cdf: 0.301121610841322 },
      { x: 0, pdf: 0.26967630059419, cdf: 0.5 },
      { x: 1.0, pdf: 0.118304657040393, cdf: 0.698878389158678 },
      { x: 2.0, pdf: 0.0518992282473726, cdf: 0.777242554908434 },
      { x: 5.0, pdf: 0.0141307479465662, cdf: 0.857004298420571 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: -0.5, pdf: 0.254647908947033, cdf: 0.352416382349567 },
      { x: 0, pdf: 0.318309886183791, cdf: 0.5 },
      { x: 0.5, pdf: 0.254647908947033, cdf: 0.647583617650433 },
      { x: 1.0, pdf: 0.159154943091895, cdf: 0.75 },
      { x: 3.0, pdf: 0.0318309886183791, cdf: 0.897583617650433 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [0, 0.3, 0.7, 1],
    refVals: [
      { x: 0.05, pdf: 0.238095238095238, cdf: 0.00595238095238095 },
      { x: 0.15, pdf: 0.714285714285714, cdf: 0.0535714285714286 },
      { x: 0.3, pdf: 1.42857142857143, cdf: 0.214285714285714 },
      { x: 0.5, pdf: 1.42857142857143, cdf: 0.5 },
      { x: 0.7, pdf: 1.42857142857143, cdf: 0.785714285714286 },
      { x: 0.85, pdf: 0.714285714285714, cdf: 0.946428571428571 },
      { x: 0.95, pdf: 0.238095238095238, cdf: 0.994047619047619 }
    ]
  }],
  refVals: [
    { x: -4, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: 0.2, pdf: 1.77777777777778, cdf: 0.288888888888889 },
      { x: 0.4, pdf: 1.33333333333333, cdf: 0.6 },
      { x: 0.6, pdf: 0.888888888888889, cdf: 0.822222222222222 },
      { x: 0.8, pdf: 0.444444444444444, cdf: 0.955555555555555 },
      { x: 0.95, pdf: 0.111111111111111, cdf: 0.997222222222222 }
    ]
  }],
  refVals: [
    { x: 4, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    params: () => [0, 1, -2, 2],
    refVals: [
      { x: -1.5, pdf: 0.135691599239823, cdf: 0.046157235726983 },
      { x: -1.0, pdf: 0.253505281737312, cdf: 0.142383613994547 },
      { x: -0.5, pdf: 0.368848008488157, cdf: 0.299410671337028 },
      { x: 0, pdf: 0.417959550235135, cdf: 0.5 },
      { x: 0.5, pdf: 0.368848008488157, cdf: 0.700589328662972 },
      { x: 1.0, pdf: 0.253505281737312, cdf: 0.857616386005453 },
      { x: 1.5, pdf: 0.135691599239823, cdf: 0.953842764273017 }
    ]
  }],
  refVals: [
  ...
  cases: [{
    ...
    params: () => [2],
    refVals: [
      { x: 0.05, pdf: 2.99573227355399, cdf: 0.1997866136777 },
      { x: 0.1, pdf: 2.30258509299405, cdf: 0.330258509299405 },
      { x: 0.3, pdf: 1.20397280432594, cdf: 0.661191841297781 },
      { x: 0.5, pdf: 0.693147180559945, cdf: 0.846573590279973 },
      { x: 0.7, pdf: 0.356674943938732, cdf: 0.949672460757113 },
      { x: 0.9, pdf: 0.105360515657826, cdf: 0.994824464092044 },
      { x: 0.98, pdf: 0.0202027073175195, cdf: 0.999798653171169 }
    ]
  }],
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: -1.0, pdf: 0.196071550526524, cdf: 0.271522659125179 },
      { x: 0, pdf: 0.24673835739412, cdf: 0.5 },
      { x: 1.0, pdf: 0.196071550526524, cdf: 0.728477340874821 },
      { x: 2.0, pdf: 0.121541415755575, cdf: 0.884823110086892 },
      { x: 3.0, pdf: 0.091225297646184, cdf: 0.987126155959889 }
    ]
  }],
  ...
  cases: [{
    ...
    params: () => [0.5, 0.5],
    refVals: [
      { x: 0.01, pdf: 6.1385597514554, cdf: 0.131876554605415 },
      { x: 0.05, pdf: 2.30496336008399, cdf: 0.271106585889975 },
      { x: 0.1, pdf: 1.42975823095691, cdf: 0.360592680838103 },
      { x: 0.3, pdf: 0.595005959596267, cdf: 0.539110365517899 },
      { x: 0.5, pdf: 0.367879441171442, cdf: 0.632120558828558 },
      { x: 1.0, pdf: 0.171909491538362, cdf: 0.756883265565786 },
      { x: 3.0, pdf: 0.0352471897115449, cdf: 0.913662370339638 }
    ]
  }],
  refVals: [
    { x: -0.1, pdf: 0, cdf: 0 },
  ...
  cases: [{
    ...
    refVals: [
      ...
      { x: -0.15, pdf: 1.21459311451714, cdf: 0.311918832390536 },
      { x: 0, pdf: 1.27323954473516, cdf: 0.5 },
      { x: 0.15, pdf: 1.21459311451714, cdf: 0.688081167609464 },
      { x: 0.3, pdf: 1.01859163578813, cdf: 0.857621510067353 },
      { x: 0.45, pdf: 0.554992250642031, cdf: 0.981306963265751 }
    ]
  }],
  refVals: [
