...
- `Bernoulli` now extends `Distribution` directly instead of `Categorical`, replacing alias-table construction with analytical `_pdf`, `_cdf`, and `_generator` implementations. No observable change to outputs (#669).
