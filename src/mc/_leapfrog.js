 ...
 * a direct, easily-verified match to the textbook algorithm. Used by NUTS (always `steps = 1`,
 * with direction folded into a signed `eps`). HMC does NOT use this module — it has its own inline
 * `_leapfrog` (hmc.js) that applies the adapted Euclidean mass matrix, which this identity-metric
 * integrator deliberately omits.
 *
